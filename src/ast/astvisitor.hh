...
protected:
    ...
    virtual void visitBoolConst(const BoolConst &node) = 0;
    virtual void visitBinaryOpExpr(const BinaryOpExpr &node) = 0;
    virtual void visitUnaryOpExpr(const UnaryOpExpr &node) = 0;
